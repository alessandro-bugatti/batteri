 ...
 * @version 1.1
 */
public class SSS extends batteri.Batterio {
    ...
    private static final int TERMINERICERCADISTANTE = 150 + TERMINERICERCAVICINA;
    //nelle rette della ricerca distante viene controllato un pixel su {INCREMENTO}
    private static final int INCREMENTO = 6;
